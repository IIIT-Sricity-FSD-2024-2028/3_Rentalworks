...
const defaultData = {
  USERS: [
    ...
    { id: 6, name: 'Rajesh Kumar', email: 'rajesh.k@email.com', phone: '+91 98765 43214', role: 'owner', property: 'Green Valley PG', status: 'active', joinDate: '2023-12-01', username: 'owner1', password: 'owner123', subscriptionPlan: 'Standard', subscriptionFee: 5000 },
    { id: 7, name: 'Priya Patel', email: 'priya.p@email.com', phone: '+91 98765 43211', role: 'owner', property: 'Sunrise Heights', status: 'active', joinDate: '2024-02-20', username: 'owner2', password: 'owner123', subscriptionPlan: 'Premium', subscriptionFee: 8000 },
    { id: 8, name: 'Sunita Rao', email: 'sunita.r@email.com', phone: '+91 98765 43218', role: 'owner', property: 'Urban Nest', status: 'active', joinDate: '2023-11-15', username: 'owner3', password: 'owner123', subscriptionPlan: 'Expired', subscriptionFee: 0 },
    ...
    { id: 11, name: 'Super Admin', email: 'superadmin@pgrentals.com', phone: '+91 00000 00000', role: 'super_admin', property: null, status: 'active', joinDate: '2024-01-01', username: 'superadmin', password: 'admin123'},
    { id: 12, name: 'Bangalore Admin', email: 'blr_admin@pgrentals.com', phone: '+91 00000 00001', role: 'admin', property: null, region: 'Koramangala, Bangalore', status: 'active', joinDate: '2024-01-02', username: 'admin', password: 'admin123'}
  ],
  PROPERTIES: [
  ...
  nextId: { user: 12, property: 5, booking: 6, payment: 5, complaint: 3, notification: 3 }
};
...
export const USERS = loadedData.USERS;
export const PROPERTIES = loadedData.PROPERTIES;
export const BOOKINGS = loadedData.BOOKINGS;
export const PAYMENTS = loadedData.PAYMENTS;
export const COMPLAINTS = loadedData.COMPLAINTS;
export const NOTIFICATIONS = loadedData.NOTIFICATIONS;
...
export const getNextId = (entity: string) => {
