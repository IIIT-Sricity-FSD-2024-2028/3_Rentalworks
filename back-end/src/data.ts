...
const defaultData = {
  USERS: [
    ...
    },
    {
      id: 11,
      name: 'Super Admin',
      email: 'superadmin@pgrentals.com',
  ...
  PAYMENTS: [
    {
      ...
      amount: 9000,
      method: 'UPI',
      transactionId: 'UPI1202603810001',
      paidDate: '2026-02-28',
      status: 'verified',
      clearance: 'Approved',
    },
    {
      ...
      transactionId: 'NEFT1202603850023',
      paidDate: '2026-03-05',
      status: 'pending',
      clearance: 'Pending',
    },
    {
      ...
      amount: 7500,
      method: 'UPI',
      transactionId: 'UPI1202603860045',
      paidDate: '2026-03-06',
      status: 'pending',
      clearance: 'Pending',
    },
    {
      ...
      amount: 7000,
      method: 'Card',
      transactionId: 'CRD1202602148009',
      paidDate: '2026-02-14',
      status: 'refunded',
      clearance: 'Approved',
    },
  ...
  NOTIFICATIONS: [
    {
      ...
      message: 'The system will be down for maintenance on March 10, 2026.',
      type: 'announcement',
      priority: 'urgent',
      recipients: 10,
      sentAt: '2026-03-07 14:30',
      by: 'Admin',
    },
    {
      id: 2,
      title: 'New Property Guidelines',
      message: 'Updated guidelines for property listings have been published.',
      type: 'update',
      priority: 'important',
      recipients: 4,
...
const nextId = loadedData.nextId;
